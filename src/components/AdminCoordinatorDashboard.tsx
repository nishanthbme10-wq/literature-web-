          ...
          <div className="space-y-6">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-gray-200 pb-4">
              <div>
                ...
                <p className="text-xs text-[#666666]">
                  Showing <strong className="text-[#171717]">{filteredUsers.length}</strong> of <strong className="text-[#171717]">{users.length}</strong> registered accounts in sorted order.
                </p>
              </div>
